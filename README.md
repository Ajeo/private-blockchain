...
1. Install node.js v10.18.1 in your computer
1. Clone this project and run `npm install` in your Terminal
1. Start the Express Server using `node app.js` command
